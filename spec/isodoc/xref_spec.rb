...
RSpec.describe IsoDoc do
  it "selects sets of assets to process crossreference for" do
    ...
    expect(xrefs.anchor("A", :xref))
      .to be_xml_equivalent_to "<span class='fmt-element-name'>Clause</span> <semx element='autonum' source='A'>1</semx>"
    expect(xrefs.anchor("B", :xref))
      .to be_xml_equivalent_to "<span class='fmt-element-name'>Note</span>"
    expect(xrefs.anchor("C", :xref))
      .to be_xml_equivalent_to "[C]"
    ...
    expect(xrefs.anchor("A", :xref))
      .to be_xml_equivalent_to "<span class='fmt-element-name'>Clause</span> <semx element='autonum' source='A'>1</semx>"
    expect(xrefs.anchor("B", :xref))
      .to be_xml_equivalent_to "[B]"

    xrefs = new_xrefs.parse_inclusions(assets: true)
    xrefs.parse(input)
    expect(xrefs.anchor("A", :xref))
      .to be_xml_equivalent_to "[A]"
    expect(xrefs.anchor("B", :xref))
      .to be_xml_equivalent_to "<span class='fmt-element-name'>Note</span>"
  end
  ...
  it "cross-references paragraphs" do
    input = <<~INPUT
            <iso-standard xmlns="http://riboseinc.com/isoxml">
            <preface>
        <foreword>
        ...
        <p id="N1">Text</p>
      <clause id="xyz"><title>Preparatory</title>
        <p id="N2" unnumbered="true">Text</p>
      </clause>
        </introduction>
        </preface>
        <sections>
        ...
        <clause id="scope2"><title>Scope 2</title>
            <p id="N3">Text</p>
            <quote id="Q1"><p id="QN1">Text</p></quote>
            <p id="N4">Text</p>
        <p><xref target="N"/></p>
            <p id="N5">Text</p>
        </clause>
        ...
        <clause id="annex1b">
            <p id="Anote1" unnumbered="true">Text</p>
            <p id="Anote2">Text</p>
        </clause>
        </annex>
                  <bibliography><references normative="false" id="biblio"><title>Bibliographical Section</title>
          ...
          <p>
             ...
             <semx element="xref" source="_">
                <fmt-xref target="N1">
                   ...
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="N1">1</semx>
                </fmt-xref>
             </semx>
             <xref target="N2" id="_"/>
             ...
             <semx element="xref" source="_">
                <fmt-xref target="N3">
                   <span class="fmt-xref-container">
                      <span class="fmt-element-name">Clause</span>
                      <semx element="autonum" source="scope2">4</semx>
                   </span>
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="N3">1</semx>
             ...
             <semx element="xref" source="_">
                <fmt-xref target="N5">
                   ...
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="N5">3</semx>
                </fmt-xref>
             </semx>
             <xref target="note1" id="_"/>
             <semx element="xref" source="_">
          ...
          <p>
             ...
             <semx element="xref" source="_">
                <fmt-xref target="N2">
                   ...
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="N02">1</semx>
                </fmt-xref>
             </semx>
             <xref target="N" id="_"/>
             <semx element="xref" source="_">
             ...
             <semx element="xref" source="_">
                <fmt-xref target="note2">
                   ...
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="note2l">1</semx>
                </fmt-xref>
             </semx>
             <xref target="AN" id="_"/>
             <semx element="xref" source="_">
             ...
             <semx element="xref" source="_">
                <fmt-xref target="Anote2">
                   ...
                   <span class="fmt-comma">,</span>
                   <span class="fmt-element-name">Paragraph</span>
                   <semx element="autonum" source="Anote2l">1</semx>
                </fmt-xref>
             </semx>
             <xref target="Anote3" id="_"/>
             <semx element="xref" source="_">
