    ...
    output = <<~OUTPUT
        <foreword id="fwd" displayorder="2">
           ...
           <p>
              ...
              <xref target="S10a" id="_"/>
              <semx element="xref" source="_">
                 <fmt-xref target="S10a">
                    <span class="fmt-element-name">Clause</span>
                    <semx element="autonum" source="S10a">2</semx>
                 </fmt-xref>
              </semx>
              <xref target="S11" id="_"/>
              <semx element="xref" source="_">
                 <fmt-xref target="S11">
                    <span class="fmt-element-name">Clause</span>
