        ...
        <main class="main-section">
           ...
           <div>
              ...
              <figure id="_" class="figure">
                 ...
                 <figcaption>Split-it-right sample divider</figcaption>
              </figure>
           </div>
        </main>
      OUTPUT
    ...
    context "when `mathvariant` attr equal to `script`" do
      it "converts mathvariant text chars into associated plain chars" do
        ...
        html = File.read("test.html")
          .sub(/^.*<main class="main-section">/m, '<main class="main-section">')
          .sub(%r{</main>.*$}m, "</main>")
        expect(html).to(be_xml_equivalent_to(output))
      end
    end
      ...
      .to be_xml_equivalent_to <<~OUTPUT
        ...
        <picture>
           <img src="test_htmlimages/_.png" height="83" width="99"/>
               ...
               <figcaption>Split-it-right sample divider</figcaption></figure>
                     </div>
                   </main>
      OUTPUT
  end
    ...
    expect(strip_guid(html))
      .to be_xml_equivalent_to <<~OUTPUT
        <main class="main-section">
           ...
           <div>
              <h1 class="ForewordTitle">Foreword</h1>
              <figure id="samplecode" class="sourcecode" spellcheck="false" translation="no"><pre>
                 <br/>
                 \u00a0 &lt;xml&gt; &amp;
                 <br/>
              </pre>
