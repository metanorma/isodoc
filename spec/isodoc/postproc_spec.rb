...
RSpec.describe IsoDoc do
  it "generates file based on string input" do
    ...
    <preface><foreword>
    <note>
  <p><a name="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f"/>These results are based on a study carried out on three different types of kernel.</p>
</note>
    </foreword></preface>
    </iso-standard>
    INPUT
  ...
  it "ignores Liquid markup in the document body" do
    ...
    <preface><foreword>
    <note>
  <p><a name="_f06fd0d1-a203-4f3d-a515-0bdba0f8d83f"/>{% elif %}These results are based on a study carried out on three different types of kernel.</p>
</note>
    </foreword></preface>
    </iso-standard>
INPUT
...
TOCLEVEL
  ...
  <p id="_ff27c067-2785-4551-96cf-0a73530ff1e6">Formerly denoted as 15 % (m/m).</p>
    ...
    html = File.read("test.html")
      .sub(
        /^.*<main class="main-section">/m,
        '<main xmlns:epub="epub" class="main-section">'
      ).sub(%r{</main>.*$}m, "</main>")
    expect(xmlpp(html)).to be_equivalent_to xmlpp(<<~"OUTPUT")
      <main  xmlns:epub="epub" class="main-section"><button onclick="topFunction()" title="Go to top"><a name="myBtn"/>Top</button>
             <p class="zzSTDTitle1"></p>
             <div><a name="A"/>
               <h1>Clause 4</h1>
               <a class='FootnoteRef' href='#fn:3'><a name='fnref:1'/>
                 <sup>1</sup>
               </a>
               <div><a name="N"/>
                <h2>Introduction to this<a class='FootnoteRef' href='#fn:2'><a name='fnref:2'/><sup>2</sup></a></h2>
              </div>
               <div><a name="O"/>
                <h2>Clause 4.2</h2>
             ...
             <aside class="footnote"><a name="fn:3"/>
         <p><a name="_ff27c067-2785-4551-96cf-0a73530ff1e6"/><a class='FootnoteRef' href='#fn:3'>
                 <sup>1</sup>
               </a>This is a footnote.</p>
       <a href="#fnref:1">&#x21A9;</a></aside>
             <aside class="footnote"><a name="fn:2"/>
...
<img src='data:application/xml;base64,' height='' width=''/>
      ...
      it "converts mathvariant text chars into associated plain chars" do
        ...
        output = <<~OUTPUT
          <main class="main-section"><button onclick="topFunction()" title="Go to top"><a name="myBtn"/>Top</button>
            ...
            <div><a name="_clause"/>
              <h1>Clause</h1>
              <p><a name="_20514f5a-9f86-454e-b6ce-927f65ba6441"/>
    ...
    context "when complex `mathvariant` combinations" do
      it "converts mathvariant text chars into associated plain chars" do
        ...
        input = <<~INPUT
          ...
          <iso-standard xmlns="https://www.metanorma.org/ns/iso" type="semantic" version="1.5.14">
            <sections>
              <clause inline-header="false" obligation="normative" id="_clause">
                <title>Clause</title>
                <p id="_20514f5a-9f86-454e-b6ce-927f65ba6441">
                  <stem type="MathML">
  ...
  <image src="data:image/*;base64,"  mimetype="image/png"><a name="_8357ede4-6d44-4672-bac4-9a85e82ab7f3"/></img>
    ...
    <main class='main-section'>
         <button onclick='topFunction()' title='Go to top'><a name="myBtn"/>Top</button>
         <br/>
         <div>
           <h1 class='ForewordTitle'>Foreword</h1>
           <div class='figure'>
...
<termsource status="identical">
  <origin bibitemid="ISO7301" type="inline" citeas="ISO 7301:2011"><locality type="clause"><referenceFrom>3.1</referenceFrom></locality></origin>
    ...
    expect(File.exist?("test.html")).to be true
    html = File.read("test.html")
    expect(html).to match(%r{<h2 class="TermNum"><a name="paddy1"></a>1\.1\.</h2>})
    expect(html).to match(%r{<h2 class="TermNum"><a name="paddy"></a>1\.2\.</h2>})
  end
...
<p id="_a27281a4-b20e-4d0b-a780-bab9e851b03e">is the number of coating layers</p>
  ...
  &lt;xml&gt; &amp;
    ...
    expect(xmlpp(html)).to be_equivalent_to xmlpp(<<~"OUTPUT")
      ...
      <div>
        <h1 class="ForewordTitle">Foreword</h1>
        <pre class="prettyprint "><a name="samplecode"/><br />&#xA0;&#xA0;&#xA0; <br />&#xA0; &lt;xml&gt; &amp;<br />
        </pre>
...
OUTPUT
  ...
  <body>
    ...
    OUTPUT
      expect(xmlpp(IsoDoc::HtmlConvert.new({wordstylesheet: "spec/assets/word.css", htmlstylesheet: "spec/assets/html.scss", filename: "test"}).html_preface(Nokogiri::XML(input)).to_xml).sub(/^.*<main/m, "<main").sub(%r{</main>.*$}m, "</main>")).to be_equivalent_to xmlpp(html)
      expect(xmlpp(IsoDoc::WordConvert.new({wordstylesheet: "spec/assets/word.css", htmlstylesheet: "spec/assets/html.scss", filename: "test"}).word_cleanup(Nokogiri::XML(input)).to_xml).sub(/^.*<main/m, "<main").sub(%r{</main>.*$}m, "</main>")).to be_equivalent_to xmlpp(word)
  end
