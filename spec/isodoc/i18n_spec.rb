...
RSpec.describe IsoDoc do
      ...
      <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
         ...
         <preface>
           ...
           <foreword obligation="informative" id="_" displayorder="2">
             ...
             <p id="A">See <xref target="M" id="_"/><semx element="xref" source="_"><fmt-xref target="M"><span class="fmt-element-name">Clause</span><semx element="autonum" source="M">5</semx></fmt-xref></semx></p>
             <p id="A">See <xref target="tab" id="_"/><semx element="xref" source="_"><fmt-xref target="tab"><span class="fmt-element-name">Table</span><semx element="autonum" source="tab">1</semx></fmt-xref></semx></p>
        ...
        <a href='#M'>Clause 5</a>
            ...
            <caption>Table 1</caption>
              ...
              .
                     ...
                     <div id="H"><h1>3<span class="fmt-clause-delim">.</span>\u00a0 Terms, definitions, symbols and abbreviated terms</h1>
             <div id="I">
              ...
              </div><div id="K"><h2>3.2<span class="fmt-clause-delim">.</span>\u00a0 Symbols</h2>
               <div class="figdl">
        ...
        presxml = <<~PRESXML
          <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
             ...
             <sections>
                ...
                <semx element="eref" source="_">
                   <fmt-xref type="inline" target="ISO712">ISOu00a0712,  Tableau 1–1</fmt-xref>
                </semx>
             </p>
                </clause>
                <clause id="H" obligation="normative" displayorder="6">
                ...
                <references id="R" obligation="informative" normative="true" displayorder="5">
                   ...
                   <fmt-xref-label>
                      ...
                      <semx element="autonum" source="R">2</semx>
                            ...
                            <bibitem id="ISO712" type="standard">
                <biblio-tag>ISOu00a0712, </biblio-tag>
                <formattedref>
                   <em>Cereals and cereal products</em>
                   .
                </formattedref>
                <title format="text/plain">Cereals and cereal products</title>
                <docidentifier>ISOu00a0712</docidentifier>
                <docidentifier scope="biblio-tag">ISOu00a0712</docidentifier>
                <contributor>
                   <role type="publisher"/>
                   <organization>
                      <abbreviation>ISO</abbreviation>
        ...
        <a href='#M'>Article 5</a>
            ...
            <p id="ISO712" class="NormRef">
             ...
             <h2>3.1<span class="fmt-clause-delim">.</span>\u00a0 Normal Terms</h2>
                <p class="TermNum" id="J">3.1.1<span class="fmt-clause-delim">.</span></p>
                <p class="Terms" style="text-align:left;"><b><dfn>Term2</dfn></b></p>
                </div><div id="K"><h2>3.2<span class="fmt-clause-delim">.</span>\u00a0 Symboles</h2>
               <div class="figdl">
                <dl><dt><p>Symbol</p></dt><dd>Definition</dd></dl>
                </div>
              </div></div>
                     <div id="L" class="Symbols">
                     <h1>4<span class="fmt-clause-delim">.</span>\u00a0 Symboles</h1>
                        <div class="figdl">
                       <dl>
                         <dt>
                           <p>Symbol</p>
      ...
      #{HTML_HDR.gsub(' lang="en">', ' lang="zh">').gsub('Table of contents', '目　次')}
            ...
            <caption>表1</caption>
             ...
             <div id="I"><h2>3.1<span class="fmt-clause-delim">.</span>\u3000Normal Terms</h2>
              ...
              <div id="K"><h2>3.2<span class="fmt-clause-delim">.</span>\u3000符号</h2>
                <div class="figdl">
                <dl><dt><p>Symbol</p></dt><dd>Definition</dd></dl>
                </div>
              </div>
             ...
             <div id="L" class="Symbols">
             <h1>4<span class="fmt-clause-delim">.</span>\u3000符号</h1>
                <div class="figdl">
               <dl>
                 <dt>
                   <p>Symbol</p>
      ...
      <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
        ...
        <preface>
          ...
          <foreword obligation="informative" id="_" displayorder="2">
            ...
            <p id="A">See <xref target="M" id="_"/><semx element="xref" source="_"><fmt-xref target="M"><span class="fmt-element-name">klaŭzo</span><semx element="autonum" source="M">5</semx></fmt-xref></semx></p>
            <p id="A">See <xref target="tab" id="_"/><semx element="xref" source="_"><fmt-xref target="tab"><span class="fmt-element-name">tabelo</span><semx element="autonum" source="tab">1</semx></fmt-xref></semx></p>
            <table id="tab" autonum="1">
              <fmt-name id="_">
                <span class="fmt-caption-label">
        ...
        <annex id="P" inline-header="false" obligation="normative" autonum="A" displayorder="9">
          ...
          <variant-title type="toc">
            <span class="fmt-caption-label">
              <span class="fmt-element-name">Aldono</span>
              <semx element="autonum" source="P">A</semx>
            </span>
            <span class="fmt-caption-delim">
              <tab/>
    ...
    html = <<~OUTPUT
      ...
      <caption>Tabelo 1</caption>
                   ...
                   <div id='H'>
                     ...
                     <div id='K'>
                       <h2>3.2<span class="fmt-clause-delim">.</span>\u00a0 Simboloj kai mallongigitaj terminoj</h2>
                        <div class="figdl">
                       <dl>
                         <dt>
                           <p>Symbol</p>
                   ...
                   <div id='L' class='Symbols'>
                     <h1>4<span class="fmt-clause-delim">.</span>\u00a0 Simboloj kai mallongigitaj terminoj</h1>
                      <div class="figdl">
                     <dl>
                       <dt>
                         <p>Symbol</p>
  ...
  it "configures admonitions icons" do
    mock_i18n
    input = <<~INPUT
          <iso-standard xmlns="http://riboseinc.com/isoxml">
          <bibdata>
    ...
    presxml = <<~INPUT
      <foreword id="fwd" displayorder="2">
        ...
        <fmt-title depth="1" id="_">
          <semx element="title" source="_">Antaŭparolo</semx>
        </fmt-title>
