    ...
    html = <<~OUTPUT
      #{HTML_HDR}
                ...
                <div id="fwd">
                   ...
                   <figure id="figureA-1" class="figure" style="page-break-after: avoid;page-break-inside: avoid;">
                      <picture>
                         <source srcset="data:image/svg+xml;base64," media="all"/>
                         <img src="data:image/svg+xml;base64," height="auto" width="auto" alt=""/>
                      </picture>
