...
RSpec.describe IsoDoc do
        ...
        <preface>
          ...
          <foreword id="fwd" displayorder="2">
            ...
            <table id="tableD-1" alt="tool tip" summary="long desc" width="70%" keep-with-next="true" keep-lines-together="true" autonum="1">
              <name id="_15">Repeatability and reproducibility of <em>husked</em> rice yield<fn original-id="_1" original-reference="1"><p>X</p></fn></name>
              <fmt-name id="_27">
                ...
                <semx element="name" source="_15">Repeatability and reproducibility of <em>husked</em> rice yield<fn reference="1" id="_1" original-reference="1" target="_20"><p>X</p><fmt-fn-label><span class="fmt-caption-label"><sup><semx element="autonum" source="_1">1</semx></sup></span></fmt-fn-label></fn></semx>
              </fmt-name>
              <fmt-xref-label>
                <span class="fmt-element-name">Table</span>
                <semx element="autonum" source="tableD-1">1</semx>
              ...
              <thead>
                ...
                <tr>
                  <td valign="top" align="left" style="background-color: green;">Arborio</td>
                  <td valign="middle" align="center">Drago<fn reference="a" id="_2" target="_14"><p original-id="_">Parboiled rice.</p><fmt-fn-label><span class="fmt-caption-label"><sup><semx element="autonum" source="_2">a</semx></sup></span></fmt-fn-label></fn></td>
                  <td valign="bottom" align="center">Balilla<fn reference="a" id="_3" target="_14"><p id="_">Parboiled rice.</p><fmt-fn-label><span class="fmt-caption-label"><sup><semx element="autonum" source="_3">a</semx></sup></span></fmt-fn-label></fn><fn reference="a" id="_4" target="_14"><p id="_">Parboiled rice.</p><fmt-fn-label><span class="fmt-caption-label"><sup><semx element="autonum" source="_4">a</semx></sup></span></fmt-fn-label></fn></td>
                  <td align="center">Thaibonnet</td>
                </tr>
              </thead>
              <tbody>
              ...
              <tfoot>
                <tr>
                  <td align="left">Reproducibility limit, <stem type="AsciiMath" id="_23">R</stem><fmt-stem type="AsciiMath"><semx element="stem" source="_23">R</semx></fmt-stem> (= 2,83 <stem type="AsciiMath" id="_24">s_R</stem><fmt-stem type="AsciiMath"><semx element="stem" source="_24">s_R</semx></fmt-stem>)</td>
                  <td align="center">2,89</td>
                  <td align="center">0,57</td>
                  <td align="center">2,26</td>
                  <td align="center">
              ...
              <key>
                <dl>
                  <name id="_19">Key</name>
                  <fmt-name id="_28">
                    <semx element="name" source="_19">Key</semx>
                  </fmt-name>
                  <dt>Drago</dt>
                  <dd>A type of rice</dd>
                </dl>
              ...
              <fmt-source>[SOURCE: <semx element="source" source="_5"><origin bibitemid="ISO712" type="inline" citeas="" id="_21"><localityStack><locality type="section"><referenceFrom>1</referenceFrom></locality></localityStack></origin><semx element="origin" source="_21"><fmt-xref type="inline" target="ISO712">ISO 712,  Section 1</fmt-xref></semx> — <semx element="modification" source="_6">with adjustments</semx></semx>; <semx element="source" source="_7"><origin bibitemid="ISO712" type="inline" citeas="" id="_22"><localityStack><locality type="section"><referenceFrom>2</referenceFrom></locality></localityStack></origin><semx element="origin" source="_22"><fmt-xref type="inline" target="ISO712">ISO 712,  Section 2</fmt-xref></semx></semx>]</fmt-source>
              ...
              <fmt-footnote-container>
                <fmt-fn-body id="_14" target="_2" reference="a">
                  <semx element="fn" source="_2">
                    <p id="_"><fmt-fn-label><span class="fmt-caption-label"><sup><semx element="autonum" source="_2">a</semx></sup></span><span class="fmt-caption-delim"><tab/></span></fmt-fn-label>Parboiled rice.</p>
                  </semx>
                </fmt-fn-body>
              </fmt-footnote-container>
            </table>
              ...
              <table id="tableD-1" class="MsoISOTable" style="border-width:1px;border-spacing:0;width:70%;page-break-after: avoid;page-break-inside: avoid;table-layout:fixed;" title="tool tip">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <td style="text-align:center;vertical-align:bottom;border-top:none;border-bottom:solid windowtext 1.5pt;" scope="col">Balilla<a href="#tableD-1a" class="TableFootnoteRef">a</a><a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                ...
                <tfoot>
                  ...
                  <tr>
                    <td colspan="5" style="border-top:0pt;border-bottom:solid windowtext 1.5pt;">
                      <div class="key">
          <div class="figdl"><p class="ListTitle">Key</p><dl><dt><p>Drago</p></dt><dd>A type of rice</dd></dl></div>
          </div>
    ...
    word = <<~OUTPUT
        <body lang="EN-US" link="blue" vlink="#954F72">
          ...
          <div class="WordSection2">
            ...
            <div id="fwd">
              <h1 class="ForewordTitle">Foreword</h1>
              <p class="TableTitle" style="text-align:center;">Table 1&#xa0;— Repeatability and reproducibility of <i>husked</i> rice yield<span style="mso-bookmark:_Ref" class="MsoFootnoteReference"><a class="FootnoteRef" epub:type="footnote" href="#ftn_20">1</a></span></p>
                ...
                <table id="tableD-1" class="MsoISOTable" style="mso-table-anchor-horizontal:column;mso-table-overlap:never;border-spacing:0;border-width:1px;page-break-after: avoid;page-break-inside: avoid;" title="tool tip" summary="long desc" width="70%">
                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td valign="middle" align="center" style="border-top:none;mso-border-top-alt:none;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:avoid;">Drago<a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                      <td valign="bottom" align="center" style="border-top:none;mso-border-top-alt:none;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:avoid;">Balilla<a href="#tableD-1a" class="TableFootnoteRef">a</a><a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                  ...
                  <tfoot>
                    <tr>
                      <td align="left" style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:0pt;mso-border-bottom-alt:0pt;page-break-after:auto;">Reproducibility limit, <span class="stem">(#(R)#)</span> (= 2,83 <span class="stem">(#(s_R)#)</span>)</td>
                    ...
                    <tr>
                      <td colspan="5" style="border-top:0pt;mso-border-top-alt:0pt;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;">
                        <div class="key">
          <div class="figdl"><p class="ListTitle">Key</p><p style="text-indent: -2.0cm; margin-left: 2.0cm; tab-stops: 2.0cm;">Drago<span style="mso-tab-count:1">&#xa0; </span>A type of rice</p></div>
          </div>
                        <div class="BlockSource">
                          <p>[SOURCE: <a href="#ISO712">ISO&#xa0;712,  Section 1</a> — with adjustments;
          <a href="#ISO712">ISO&#xa0;712,  Section 2</a>
  ...
  it "processes plain IsoXML tables" do
    ...
    presxml = <<~OUTPUT
      <iso-standard xmlns="http://riboseinc.com/isoxml" type="presentation">
               ...
               <table id="tableD-1" alt="tool tip" summary="long desc" width="70%" keep-with-next="true" keep-lines-together="true" plain="true" autonum="1">
                  ...
                  <fmt-name id="_21">
                     ...
                     <semx element="name" source="_11">
                        ...
                        <em>husked</em>
                        rice yield
                        <fn reference="1" id="_1" original-reference="1" target="_14">
                           <p>X</p>
                           <fmt-fn-label>
                              <span class="fmt-caption-label">
                                 <sup>
                  ...
                  <thead>
                     ...
                     <tr>
                        ...
                        <td valign="middle" align="center">
                           Drago
                           <fn reference="a" id="_2" target="_10">
                        ...
                        <td valign="bottom" align="center">
                           Balilla
                           <fn reference="a" id="_3" target="_10">
                  ...
                  <fmt-footnote-container>
                     <fmt-fn-body id="_10" target="_2" reference="a">
                        <semx element="fn" source="_2">
                           <p id="_">
                              <fmt-fn-label>
                                 <span class="fmt-caption-label">
         ...
         <fmt-footnote-container>
            <fmt-fn-body id="_14" target="_1" reference="1">
               <semx element="fn" source="_1">
                  <p>
                     <fmt-fn-label>
                        <span class="fmt-caption-label">
    ...
    html = <<~OUTPUT
         ...
         <div class="main-section">
           ...
           <br/>
              <div id="fwd">
                  <h1 class="ForewordTitle">Foreword</h1>
                  <table class="plain" id="tableD-1" style="width:70%;page-break-after: avoid;page-break-inside: avoid;table-layout:fixed;" title="tool tip">
                     <caption>Table 1\u00a0— Repeatability and reproducibility of <i>husked</i> rice yield<a class="FootnoteRef" href="#fn:_14"><sup>1</sup></a><span style="display:none">long desc</span></caption>
                     <colgroup>
                        <col style="width: 30%;"/>
                        <col style="width: 20%;"/>
                        <col style="width: 20%;"/>
    ...
    word = <<~OUTPUT
      <body lang="EN-US" link="blue" vlink="#954F72">
        ...
        <div class="WordSection2">
          ...
          <div id="fwd">
            <h1 class="ForewordTitle">Foreword</h1>
            <p class="TableTitle" style="text-align:center;">Table 1 — Repeatability and reproducibility of <i>husked</i> rice yield<span style="mso-bookmark:_Ref" class="MsoFootnoteReference"><a class="FootnoteRef" epub:type="footnote" href="#ftn_14">1</a></span></p>
            <div align="center" class="table_container">
              <table id="tableD-1" class="MsoNormalTable" style="mso-table-anchor-horizontal:column;mso-table-overlap:never;page-break-after: avoid;page-break-inside: avoid;" title="tool tip" summary="long desc" width="70%">
                ...
                <thead>
                  ...
                  <tr>
                    <td valign="top" align="left" style="background-color: green;;page-break-after:avoid;">Arborio</td>
                    <td valign="middle" align="center" style="page-break-after:avoid;">Drago<a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                    <td valign="bottom" align="center" style="page-break-after:avoid;">Balilla<a href="#tableD-1a" class="TableFootnoteRef">a</a></td>
                ...
                <tfoot>
                  <tr>
                    <td align="left" style="page-break-after:auto;">Reproducibility limit, <span class="stem">(#(R)#)</span> (= 2,83 <span class="stem">(#(s_R)#)</span>)</td>
    ...
    expect(strip_guid(output.to_xhtml))
      .to be_html5_equivalent_to html
    output = IsoDoc::WordConvert.new({})
      .convert("test", pres_output, true)
    output = Nokogiri::HTML5(output)
    output.at("//div[@class='TOC']")["id"] = "_"
    output = output.at("//body")
    expect(strip_guid(output.to_xhtml)
      .gsub(/mso-bookmark:_Ref\d+/, "mso-bookmark:_Ref"))
      ...
      <p class="page-break">
        <br clear="all" style="mso-special-character:line-break;page-break-before:always"/>
             ...
             <div id="_">
               ...
               <div align='center' class='table_container'>
                 <table id='tableD-1' class='MsoISOTable' style='mso-table-anchor-horizontal:column;mso-table-overlap:never;border-spacing:0;border-width:1px;page-break-after: avoid;page-break-inside: avoid;' title='tool tip' summary='long desc' width='70%'></table>
               </div>
             </div>
             <p>\u00a0</p>
           </div>
  ...
  it "processes nested tables" do
        ...
        <br/>
         <div>
            ...
            <table id="tableD-1" class="MsoISOTable" style="border-width:1px;border-spacing:0;width:70%;page-break-after: avoid;page-break-inside: avoid;" title="tool tip">
               ...
               <thead>
                  <tr>
                     <td style="border-top:solid windowtext 1.5pt;border-bottom:solid windowtext 1.5pt;" scope="col">X</td>
                  </tr>
               </thead>
               <tbody>
                  <tr>
             ...
             <div align="center" class="table_container">
                ...
                <table class="MsoISOTable" style="mso-table-anchor-horizontal:column;mso-table-overlap:never;border-spacing:0;border-width:1px;page-break-after: avoid;page-break-inside: avoid;" title="tool tip" summary="long desc" width="70%">
                   ...
                   <tbody>
                      <tr>
                         <td style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:solid windowtext 1.0pt;mso-border-bottom-alt:solid windowtext 1.0pt;page-break-after:avoid;">
                            <p style="page-break-after:avoid" class="MsoNormal">1</p>
                         </td>
                      </tr>
                      <tr>
                         <td style="border-top:none;mso-border-top-alt:none;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:auto;">
                            <div align="center" class="table_container" style="page-break-after:auto">
                               <table class="MsoISOTable" style="mso-table-anchor-horizontal:column;mso-table-overlap:never;border-spacing:0;border-width:1px;">
                                  <tbody>
                                     <tr>
                                        <td style="border-top:solid windowtext 1.5pt;mso-border-top-alt:solid windowtext 1.5pt;border-bottom:solid windowtext 1.5pt;mso-border-bottom-alt:solid windowtext 1.5pt;page-break-after:auto;">
                                           <p style="page-break-after:auto;page-break-after:auto" class="MsoNormal">2</p>
                                        </td>
                                     </tr>
                                  </tbody>
                               </table>
    ...
    output = Nokogiri::HTML5(IsoDoc::HtmlConvert.new({})
      .convert("test", input, true))
    output.at("//div[@class='TOC']")["id"] = "_"
    output = output.at("//div[@class = 'main-section']")
    expect(strip_guid(output.to_xhtml))
      .to be_html5_equivalent_to html
    IsoDoc::WordConvert.new({})
      .convert("test", input, false)
    output = File.read("test.doc")
      .sub(/^.*<html/m, "<html").sub(/<\/html>.*$/m, "")
    output = Nokogiri::HTML5(output)
    output = output.at("//div[@class='WordSection2']")
    expect(strip_guid(output.to_xhtml
      .gsub(/mso-bookmark:_Ref\d+/, "mso-bookmark:_Ref")))
      .to be_html4_equivalent_to word
  end
